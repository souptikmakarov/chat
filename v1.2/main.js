$(document).ready(function(){
	...
	function showThread (e) {
		...
		if(element.getAttribute('class')=="thread-container"){
			console.log("Please click on a conversation");
			return;
		...
		console.log("User id="+id+"  Conversation id="+cid+"  Last message="+lastMessage+"  Friend id="+friendId);
		$('.chat-messages').empty();
		conversation(id,cid,lastMessage,friendId);
	}
